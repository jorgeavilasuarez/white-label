...
--allowed-unrecognized-property webkit-backface-visibility ^
--allowed-unrecognized-property backface-visibility ^
...
--allowed-unrecognized-property column-count  ^
--allowed-unrecognized-property ms-touch-action  ^
--allowed-unrecognized-property touch-action  ^
--allowed-unrecognized-property outline-offset  ^
--allowed-unrecognized-property -webkit-overflow-scrolling  ^
--allowed-unrecognized-property -ms-overflow-style  ^
...
--rename CLOSURE ^
--output-renaming-map "..\precompiled\RENAMING_MAP_FLIGHTS_BOOTSTRAP.js" ^
--output-file "..\precompiled\BOOTSTRAP"  ^
--vendor WEBKIT ^
MODULE_FLIGHTS_SEARCH_BOOTSTRAP:"..\css\bootstrap.css"