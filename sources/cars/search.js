...
goog.require('cars.template.search');
...
goog.inherits(cars.Search, goog.ui.Component);
/**
 * Creates an initial DOM representation for the component.
 * @override
 */
cars.Search.prototype.createDom = function () {
    goog.base(this, 'createDom');
    this.setId("TCSearch");
    this.SetIDs();
    var element_ = this.getElement();
    element_.innerHTML = cars.template.search.searchForm({ ids: this.ids }, null);
};
cars.Search.prototype.SetIDs = function () {
    this.ids = this.makeIds({
        lbCar: "lbCar",
        txtCarCiudRecoge: "txtCarCiudRecoge",
        txtCarCiudEntrega: "txtCarCiudEntrega",
        txtCiudadDestino: "txtCiudadDestino",
        txtCarFechaRecoge: "txtCarFechaRecoge",
        txt2CFechaEntrega: "txt2CFechaEntrega",
        ddlCarHoraRecoge: "ddlCarHoraRecoge",
        frmAir: "frmAir",
...
cars.Search.prototype.createCortinilla = function () {
...
cars.Search.prototype.token = null;
/**
 * Called when component's element is known to be in the document.
 * @override
 */
cars.Search.prototype.enterDocument = function () {
    goog.base(this, 'enterDocument');
    if (!goog.DEBUG) {
        //this.setConfiguration();
        this.onCssLoaded(MODULE_CARS_SEARCH_CSS);
    }
    ...
    this.txtCarCiudRecoge = goog.dom.getElement(this.ids.txtCarCiudRecoge);
    this.txtCarCiudEntrega = goog.dom.getElement(this.ids.txtCarCiudEntrega);
    this.txtCiudadDestino = goog.dom.getElement(this.ids.txtCiudadDestino);
    ...
    this.ddlCarHoraRecoge = goog.dom.getElement(this.ids.ddlCarHoraRecoge);
    ...
    this.btn_buscar_ = goog.dom.getElement(this.ids.lbCar);
 ...
 * @param {object} event 
 */
cars.Search.prototype.onChangedropdownlist_Habitaciones_Hoteles = function (event) {
 ...
 * @param {object} event 
 */
cars.Search.prototype.onClickOnSelectedTab = function (event) {
    ////debugger;
    var objeto = event.currentTarget;
 ...
 * @param {object} event 
 */
cars.Search.prototype.onClickAgregarQuitarMultiplesDestinos = function (event) {
    var objeto = event.currentTarget;
 ...
 * @param {object} event 
 */
cars.Search.prototype.onClickRadiosModalidadVuelos = function (event) {
 ...
 */
cars.Search.prototype.setDatePickers = function () {
 ...
 */
cars.Search.prototype.onCssLoaded = function (datos) {
 ...
 * @param {object} datos 
 */
cars.Search.prototype.onIataCodesLoaded = function (iata_codes) {
    //debugger;
 ...
 * @override
 */
cars.Search.prototype.exitDocument = function () {
 ...
 */
cars.Search.prototype.onBuscarClick_ = function (event) {
    ...
    if (typeof (window["EventSource"]) !== "undefined") {
        //this.Searchcars(dataPayload);
        //debugger;
        this.SearchcarsIE(dataPayload);
    } else {
        this.SearchcarsIE(dataPayload);
    }
};
 ...
 * @param {object} event 
 */
cars.Search.prototype.onChangedropdownlistMultiEdades = function (event) {
    var objeto = event.currentTarget;
 ...
 */
cars.Search.prototype.ocultarEdadesNinos = function () {
    try {
 ...
 */
cars.Search.prototype.ocultarEdadesBebes = function () {
    try {
...
cars.Search.prototype.createContainer = function (e) {
 ...
 */
cars.Search.prototype.OnModuleResultsLoaded = function (e) {
    //debugger;
    ...
    this.objresultados = new cars.Results(null, this.passenger, this.cortinilla, this);
    //if (this.objRender !== null) {
    ...
    //this.cortinilla.style.display = "none";
    //    this.objresultados = new cars.Results(this.dataResults);
    //    this.objresultados.render();
};
/**
 * Busca vuelos
 ...
 * @returns {undefined}
 */
cars.Search.prototype.Searchcars = function (strDataForm) {
    ...
    moduleManager.execOnLoad('cars_results', goog.bind(this.OnModuleResultsLoaded, this));
};

cars.Search.prototype.SearchcarsIE = function (strDataForm) {
...
cars.Search.prototype.setConfiguration = function () {
...
cars.Search.prototype.setDisplayChild = function (display) {
 ...
 */
moduleManager.setLoaded('cars_search');


this.objSearch = new cars.Search();
