goog.provide("hotels.Register");
goog.require('hotels.template.register');
 ...
 */
hotels.Register = function (objResults) {
    this.objResults = objResults;
    goog.ui.Component.call(this);
};

goog.inherits(hotels.Register, goog.ui.Component);

/**
 * Creates an initial DOM representation for the component.
 * @override
 */
hotels.Register.prototype.createDom = function () {
    ...
    this.contenido = hotels.template.register.register({segmentSelected: this.objResults.segmentSelected});
};
/**
 * Called when component's element is known to be in the document.
 * @override
 */
hotels.Register.prototype.enterDocument = function () {
    goog.base(this, 'enterDocument');
    var elemento = this.getElement();
    elemento.innerHTML = this.contenido;

    if (!goog.DEBUG) {
        this.MODULE_REGISTER_CSS = goog.style.installStyles(MODULE_REGISTER_CSS);
    }
    ...
    //this.passengerInfoDiv.innerHTML = hotels.template.register.passengerInfo({passengerInfo: this.passengerInfo});
 ...
 * @override
 */
hotels.Register.prototype.exitDocument = function () {
...
hotels.Register.prototype.onReserveClick = function () {
    //debugger;
 ...
 */
moduleManager.setLoaded('hotels_register');